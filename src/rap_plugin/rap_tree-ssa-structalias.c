...
/* Support RAP dynamic optimizations 
   Changed by David fuqiang Fan <feqin1023@gmail.com>*/
...
struct simple_ipa_opt_pass pass_rap_pta =
{
 {
  SIMPLE_IPA_PASS,
  "rap_pta",		                /* name */
